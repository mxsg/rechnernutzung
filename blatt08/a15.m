...
(* Chebyshev-Polynome *)
gCheby[x] := 1/Sqrt[1-x^2]; aCheby = -1; bCheby = 1; nmax = 5;
...
(* Laguerre-Polynome *)
gLag[x] := Exp[-x]; aLag = 0; bLag = Infinity; nmax = 5;
...
(* Hermite-Polynome *)
gHerm[x] := Exp[-x^2]; aHerm = -Infinity; bHerm = Infinity; nmax = 5;
